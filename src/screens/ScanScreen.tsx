...
export function ScanScreen() {
    ...
    return (
      <Screen padded>
        <Stack gap={4}>
          ...
          <Text tone="muted">We use the camera only to capture receipts. The image stays on this device.</Text>
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#000' }}>
      <Camera style={{ flex: 1 }} device={device} isActive={focused} outputs={[photoOutput]} />
      <View
        pointerEvents="box-none"
        style={{ position: 'absolute', top: 60, left: 24, right: 24 }}>
        <Card variant="muted" padding={3} style={{ backgroundColor: 'rgba(0,0,0,0.55)' }}>
          ...
          <Text style={{ color: '#fff' }}>Place the receipt on a flat surface and capture.</Text>
        </Card>
      </View>
      <View
        style={{
